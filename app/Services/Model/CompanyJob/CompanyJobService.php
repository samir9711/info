...
namespace App\Services\Model\CompanyJob;

use App\Services\Basic\BasicCrudService;
use App\Services\Basic\ModelColumnsService;
use App\Models\CompanyJob;
use App\Http\Resources\Model\CompanyJobResource;
...
class CompanyJobService extends BasicCrudService
{
    ...
    protected function setVariables(): void
    {
        $this->modelColumnsService = ModelColumnsService::getServiceFor(
            $this->model = CompanyJob::class
        );

        $this->resource = CompanyJobResource::class;
        $this->relations = ['company','currency'];
    }
