...
namespace App\Services\Model\CompanySection;

use App\Services\Basic\BasicCrudService;
use App\Services\Basic\ModelColumnsService;
use App\Models\CompanySection;
use App\Http\Resources\Model\CompanySectionResource;
use App\Http\Requests\Basic\BasicRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Validation\ValidationException;

class CompanySectionService extends BasicCrudService
{
    /**
    ...
    protected function setVariables(): void
    {
        $this->modelColumnsService = ModelColumnsService::getServiceFor(
            $this->model = CompanySection::class
        );

        $this->resource = CompanySectionResource::class;
    }
