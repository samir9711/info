...
namespace App\Services\Model\CompanyRecommendedCourse;

use App\Services\Basic\BasicCrudService;
use App\Services\Basic\ModelColumnsService;
use App\Models\CompanyRecommendedCourse;
use App\Http\Resources\Model\CompanyRecommendedCourseResource;
use App\Http\Requests\Basic\BasicRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Validation\ValidationException;

class CompanyRecommendedCourseService extends BasicCrudService
{
    /**
    ...
    protected function setVariables(): void
    {
        $this->modelColumnsService = ModelColumnsService::getServiceFor(
            $this->model = CompanyRecommendedCourse::class
        );

        $this->resource = CompanyRecommendedCourseResource::class;
        $this->relations = ['course', 'company'];
    }
