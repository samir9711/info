...
namespace App\Services\Model\CompanyGalleryImage;

use App\Services\Basic\BasicCrudService;
use App\Services\Basic\ModelColumnsService;
use App\Models\CompanyGalleryImage;
use App\Http\Resources\Model\CompanyGalleryImageResource;
use App\Http\Requests\Basic\BasicRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Validation\ValidationException;

class CompanyGalleryImageService extends BasicCrudService
{
    /**
    ...
    protected function setVariables(): void
    {
        $this->modelColumnsService = ModelColumnsService::getServiceFor(
            $this->model = CompanyGalleryImage::class
        );

        $this->resource = CompanyGalleryImageResource::class;
    }
